  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between mt-[-88px] mb-[72px] md:max-w-[540px] md:mx-auto md:mb-[52px] md:mt-[-150px]">
      <div className="container px-6 mx-auto relative">
        ...
        {/* the list */}
        <div className="bg-white dark:bg-[#25273D] py-1 px-5 rounded-[5px] w-full overflow-hidden shadow-md md:px-6 md:py-[10px]">
          {filteredTodos.length > 0 ? (
            <Reorder.Group axis="y" onReorder={setFilteredTodos} values={filteredTodos}>
              <div className="relative divide-y-[1px] divide-[#E3E4F1] dark:divide-[#393A4B]">
            ...
            <p className="text-[12px] tracking-[-.17px] text-dark49 dark:text-grey text-center py-[10px] md:text-[18px] md:tracking-[-.25px] md:py-5">
              You have no items in this list.
            </p>
          )}

          {/* list controls */}
          <div className="py-4 flex justify-between items-center bg-white dark:bg-[#25273D] border-t-[1px] border-[#E3E4F1] dark:border-[#393A4B] md:py-5">
            ...
            <div className="flex justify-center items-center bg-white dark:bg-[#25273D] absolute mx-6 bottom-[75px] font-bold text-grey94 dark:text-grey text-[14px] tracking-[-.19px] left-0 right-0 mx-auto space-x-[18px] md:relative md:bottom-0 md:w-[50%] md:text-center">
              ...
              <p
                className={`${filterStatus === "active" ? "text-darkBlue" : ""} cursor-pointer hover:text-dark49 dark:hover:text-[#E3E4F1]`}
                onClick={() => {
              ...
              <p
                className={`${filterStatus === "completed" ? "text-darkBlue" : ""} cursor-pointer hover:text-dark49 dark:hover:text-[#E3E4F1]`}
            ...
            <p
              className="text-grey94 dark:text-grey text-[12px] tracking-[-.17px] cursor-pointer hover:text-dark49 dark:hover:text-[#E3E4F1] md:text-[14px] md:tracking-[-.19px] md:w-[30%] md:text-right"
        ...
        <div className="h-[48px] bg-white dark:bg-[#25273D] rounded-[5px] mt-4 shadow-md md:hidden" />

        <p className="text-grey94 dark:text-grey mt-10 text-center text-[14px] tracking-[-.19px] md:mt-[50px]">Drag and drop to reorder list</p>
      </div>
    </main>
  );
}
